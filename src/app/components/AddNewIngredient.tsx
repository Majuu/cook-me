        ...
        <View style={styles.container}>
            ...
            {({ handleSubmit, handleChange, values, setFieldValue, isValid }) => (
                ...
                {isPredefinedListVisible ? 
                    <CustomPicker reference={ingredientPickerRef} style={styles.innerDistance} list={predefinedIngredients} placeholder={'Select ingredient'} onChange={handleChange('name')}/>
                    :
                ...
                <View style={[styles.innerDistance, styles.singleLineInputsContainer]}>
                    <CustomInput onChange={handleChange('amount')}
                        value={values.amount.toString()} style={styles.amountPicker} numberedInput placeholder={'Amount'}></CustomInput>
                    <CustomPicker reference={unitPickerRef} style={styles.unitPicker} list={ingredientUnits} placeholder={'Unit'} onChange={handleChange('unit')} />
                </View>
                <View style={styles.singleLineInputsContainer}>
                    ...
                    <CustomButton disabled={!isValid} text="Add" onPress={handleSubmit} />
                </View>
                </>
            )}
            </Formik>
