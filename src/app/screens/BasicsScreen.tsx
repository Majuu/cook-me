...
const BasicsScreen: FunctionComponent = (): React.ReactElement => {
  ...
  const instructionsList = useSelector(
    (state: RootState) => state.instructions.instructionsList,
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <CustomText
        text={
          'Take a look how to cook daily in the kitchen with the most basic video instructions. Practise and become better!'
        }
        fontSize={16}
        fontFamily={FontsEnum.SEN_REGULAR}
        color={ColorsEnum.DARK_GREEN}
